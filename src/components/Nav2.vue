<template>
  <nav>
    ...
    <ul :class="showMenu ? 'nav-links nav-active' : 'nav-links'">
      ...
      <li>
        <a href="https://m.me/solardelalca.mx" target="_blank" :class="active == 3 ? 'active' : ''" @click="setActive(3)"
          >Contacto</a
        >
      </li>
      <li>
...
a.active:before {
  content: url("~@/assets/img/nav-selected-line.svg");
